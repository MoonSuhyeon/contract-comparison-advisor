...
[`01_문제정의.md`](01_문제정의.md)). 이 프로젝트가 묻는 질문은 "AI가 계약을 잘
...
naive/structured 차이에서 지침과 스키마가 각각 얼마나 기여했는지 분리해봤습니다. 전체 검증
과정과 평가기 자체 버그 9건의 상세 기록은 [`04_검증결과.md`](04_검증결과.md) 참고.
...
├── 02_설계.md                 # 테스트 설계·평가 규칙 확정 이력 (발견 → 수정 → 재확정)
├── 03_테스트케이스.md          # 15개 테스트 케이스 목적·입력·기대결과·중요도 원본 설계
...
[`06_종합정리.md`](06_종합정리.md) 5번 항목과 [`04_검증결과.md`](04_검증결과.md) 7번 항목에
기록되어 있습니다.
