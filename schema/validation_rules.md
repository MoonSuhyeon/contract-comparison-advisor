...
기준: `설계_확정본.md` §3, `schema/output_schema.json`. 여기 없는 항목(다중 축 동시 감점 여부 등)은
...
## 0. 매칭 키 규칙 (설계_확정본.md §3-4, TC-01/TC-03 실행 중 발견·확정)
...
**B2. GT 미등록 신규 item 처리 (설계_확정본.md §3-2 그대로 적용)**
...
## E. Boundary Violation — 판단어 검사 (2단계, 설계_확정본.md §3-3)
